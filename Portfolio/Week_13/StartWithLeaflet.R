...
DANmap_final <- DANmap %>%   addMarkers(lng = places2$Longitude, 
                        lat = places2$Latitude,
                        popup = paste("<b>Placename:</b>", places2$Placename,"<br>",
                                      "<b>Description:</b>", places2$Description, "<br>", 
                                      "<b>Type:</b>", places2$Type, "<br>",
                                      "<b>Notes:</b>", places2$Notes, "<br>"),
                        clusterOptions = markerClusterOptions())

saveWidget(DANmap_final, "DANmap.html", selfcontained = TRUE)
